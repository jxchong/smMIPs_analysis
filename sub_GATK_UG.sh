...
java -Xmx32g -jar $nodebin/executables/GenomeAnalysisTK.jar \
...
$nodebin/executables/bgzip -c multisample_calls/$2.UG.multisample.realigned.polymorphic.filtered.vcf > multisample_calls/$2.UG.multisample.realigned.polymorphic.filtered.vcf.gz
$nodebin/executables/tabix -p vcf multisample_calls/$2.UG.multisample.realigned.polymorphic.filtered.vcf.gz
